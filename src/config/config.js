...
export const MONGOOSE_DB_COLLECTION_USERS =
  process.env.MONGOOSE_DB_COLLECTION_USERS;
export const MONGOOSE_DB_COLLECTION_PRODUCTS =
  process.env.MONGOOSE_DB_COLLECTION_PRODUCTS;
export const MONGOOSE_DB_COLLECTION_CARTS =
  process.env.MONGOOSE_DB_COLLECTION_CARTS;
export const MONGOOSE_DB_COLLECTION_TICKETS =
  process.env.MONGOOSE_DB_COLLECTION_TICKETS;

export const PASSPORT_GITHUB_CLIENTID = process.env.PASSPORT_GITHUB_CLIENTID;
export const PASSPORT_GITHUB_CLIENTSECRET =
  process.env.PASSPORT_GITHUB_CLIENTSECRET;
export const PASSPORT_GITHUB_CALLBACKURL =
  process.env.PASSPORT_GITHUB_CALLBACKURL;
